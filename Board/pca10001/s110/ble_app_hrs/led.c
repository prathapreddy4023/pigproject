...
static void timer1_init(void)
{
    ...
    NRF_TIMER1->PRESCALER = 4;//TIMER_PRESCALER;
    ...
    NRF_TIMER1->CC[0] = 1;//CAPTURE_COMPARE_0_VALUE;
...
void square_wave_start(void)
{
    nrf_gpio_cfg_output(SQUARE_WAVE_PIN_NO);
...
void square_wave_stop(void)
{
    ...
    nrf_gpio_pin_set(SQUARE_WAVE_PIN_NO);
}
